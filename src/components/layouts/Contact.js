      ...
      <div className={classes['contact']}>
         ...
         <div className={`d-flex flex-column justify-content-start align-items-start fs-5`}>
                ...
                <div className={`d-flex flex-direction-row align-items-center justify-content-center gap-2 mb-1 ${classes['call-container']}`}>
                  <a href="tel:9876543212"><img src={callIcon} alt="Call Icon" srcSet="" /></a>
                ...
                <div className={`d-flex flex-direction-row align-items-start justify-content-center gap-2 mb-1 ${classes['message-container']}`}>
                  <a href="https://api.whatsapp.com/send?phone=9876543212"><img src={MessageIcon} alt="Message Icon" srcSet="" /></a>
                  <p style={{ fontSize: 'medium' }} className='mb-0'>Send WhatsApp Message <br /> 9876543212</p>
                </div>
